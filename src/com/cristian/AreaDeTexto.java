...
/**
 * Classe responsável por funções lógicas do JTextArea atual. Possui métodos
 * para detecção da linguagem de programação, além de métodos para salvar e
 * abrir arquivos.
 *
...
public class AreaDeTexto extends JPanel {
     ...
     * armazena a extensão e sintaxe da linguagem. Também define o recurso de
    ...
    /**
     * Método responsável por abrir determinado arquivo selecionado pelo
     * usuário. Existem casos em que podem ser lançadas exceções. Como o caso de
     * o arquivo ser um diretório ou não ser um formato válido.
     *
    ...
    /**
     * Método responsável por salvar o arquivo e, por consequência, defini-lo
     * como não modificado.
     */
     ...
     * Será usado em duas situações, caso o usuário ainda não tenha salvo o
     * arquivo (o arquivo é nulo) ou quando o usuário pressionar o botão de
     * salvar como.
     */
    ...
    /**
     * Método que configura a variável "modificado", esta será usada para
     * definir o título. Entre outras funções, como verificar se o arquivo será
     * fechado sem estar salvo.
     *
     * @param modificado boolean - valor que será passado à variável de
     * instância
     */
    ...
    /**
     * Método que pega a extensão do arquivo, define a linguagem (JLabel do
     * canto inferior direito) e sintaxe. Se o arquivo for um Potigol(.poti), o
     * botão para executar o código será liberado (contanto que o arquivo não
     * seja nulo).
     *
    ...
    /**
     * Método que compara a extensão com a linguagem para, enfim, definir o nome
     * que será exibido no JLabel.
     */
    ...
    /**
     * Método responsável por criar e configurar o JTextArea, cria um, caso não
     * exista, define o tema e fonte.
     */
