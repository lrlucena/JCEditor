...
public class Preferencias {
    ...
    /**
     * Verifica se os arquivos necessários existem, em caso negativo, cria os
     * arquivos com configurações padrão.
     */
    ...
    /**
     * Abre os arquivos da última execução através do caminho que está salvo no
     * arquivo "arquivos.list".
     */
    ...
    /**
     * Método responsável por carregar as preferências do usuário (Look And
     * Feel), tema, fonte e tamanho da mesma.
     */
    public void abrirPreferencias() {
        try {
            ...
            editor.updateFonte();
        } catch (IOException | ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException | NumberFormatException ex) {
            ex.printStackTrace();
        }
    }
    ...
    /**
     * Salva o caminho dos arquivos (contidos na ArrayList), para serem abertos
    ...
    /**
     * Método responsável por descompactar o arquivo de configurações do
     * Potigol. Se a descompactação for bem sucedida, será exibida uma mensagem
     * dizendo isso. Vale notar que em sistemas como o Linux, será necessária a
     * primeira execução via Terminal, utilizando o comando "java -jar
     * JCEditor.jar". Em seguida, deve ser dada a permissão para a execução do
     * compilador do Potigol "chmod 777 ${HOME}/ConfigJCE/.potigol/potigol.jar".
     */
