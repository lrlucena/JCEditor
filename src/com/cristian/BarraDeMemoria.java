...
public class BarraDeMemoria extends JProgressBar {
    ...
    /**
     * O construtor se encarrega de definir o valor máximo da barra de
     * progresso, determina se a barra deve processar uma cadeia de progresso,
     * define uma String nula para a barra e chama o método que inicia o Thread.
     */
    ...
    /**
     * Cria um novo Thread, define ele como daemon, para não impedir a JVM de
     * sair enquanto ele estiver em execução, por fim, o Thread é iniciado.
     */
    public void iniciar() {
    ...
    /**
     * Responsável por capturar a quantidade de mémoria e atualizar a barra de
     * progresso (String e valor da barra).
     */
